const rpgGameEquipmentData = [
  ...
  { id: "datouziWp", name: "单面骰子", icon: rpgGameIconData.touZi, eqpType: 'weapon', randomGain: true, randomProps: ['bigAttackRange'], bigAttackRange: [100, 600],description:'你能获得最好的骰子吗', },
  ...
  { id: "datouziAm", name: "宽面骰子", icon: rpgGameIconData.touZi, randomGain: true, randomProps: ['bigDefnedRange'], bigDefnedRange: [100, 600], eqpType: 'armor', rate: 5,description:'这种骰子也许能用来做井盖', },
  ...
  { id: "datouziAcs", name: "骰子吊坠", icon: rpgGameIconData.touZi, criticalRate: Math.floor(Math.random() * 100) + 1, criticalDamage: Math.floor(Math.random() * 100), eqpType: 'accessory', randomGain: true, randomProps: ['criticalRateRange', 'criticalDamageRange'], criticalRateRange: [1, 100], criticalDamageRange: [1, 100], rate: 5,description:'对于赌徒来说这骰子棒极了' },
